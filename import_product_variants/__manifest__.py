...

{
    ...
    """,
    'author': 'BROWSEINFO',
    'website': 'https://www.browseinfo.com/demo-request?app=import_product_variants&version=18&edition=Community',
    ...
    'installable': True,
    'auto_install': False,
    "live_test_url":'https://www.browseinfo.com/demo-request?app=import_product_variants&version=18&edition=Community',
